  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form enctype="multipart/form-data" method="POST" action="<?= base_url('barangmasuk/tambah') ?>" autocomplete="off">
...
<div class="modal fade" id="EditModal" tabindex="-1" role="dialog" aria-labelledby="EditModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form enctype="multipart/form-data" method="POST" action="<?= base_url('barangmasuk/edit') ?>" autocomplete="off">
        <div class="modal-body">
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
            ...
            <tbody>
              ...
              foreach ($barangmasuk as $data) : ?>
                <tr>
                  ...
                  <?php if ($this->session->userdata('level') != 3) : ?>
                    <td>
                      <form action="<?= base_url('barangmasuk/hapus/'), $data->id_bmasuk ?>" method="POST">
                        <a href="<?= base_url("/tbarangmasuk/index/$data->id_bmasuk") ?>" class="btn btn-info btn-sm">Isi Barang</a>
...
<script>
  $(document).on('click', '.open_modal', function() {
    var url = "<?= base_url() ?>barangmasuk/get";
    var id = $(this).val();

  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form enctype="multipart/form-data" method="POST" action="<?= base_url('tpermintaan/tambah') ?>" autocomplete="off">
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-group focused">
                    <label class="form-control-label" for="jumlah_permintaan">Jumlah Permintaan<span class="small text-danger">*</span></label>
                    <input type="text" id="jumlah_permintaan" class="form-control" name="jumlah_permintaan" placeholder="Jumlah Permintaan">
                  </div>
                  <div class="form-group focused">
            ...
            <tbody>
              ...
              foreach ($data as $data) : ?>
                <tr>
                  ...
                  <td>
                    <form action="<?= base_url('tpermintaan/hapus/'), $id . "/" . $data->id_trpermintaan ?>" method="POST">

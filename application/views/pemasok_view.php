  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form enctype="multipart/form-data" method="POST" action="<?= base_url('pemasok/tambah') ?>" autocomplete="off">
            ...
            <div class="">
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="form-group focused">
                    <label class="form-control-label" for="no_hp">No Hp<span class="small text-danger">*</span></label>
...
<div class="modal fade" id="EditModal" tabindex="-1" role="dialog" aria-labelledby="EditModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form enctype="multipart/form-data" method="POST" action="<?= base_url('pemasok/edit') ?>" autocomplete="off">
        <div class="modal-body">
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
          <input type="hidden" name="_method" value="PUT">
          <div class="">
            <div class="row">
              <input type="hidden" id="id_edit" class="form-control" name="id_pemasok">
              <div class="col-lg-12">
                <div class="form-group focused">
                  <label class="form-control-label" for="nama">Nama<span class="small text-danger">*</span></label>
                ...
                <div class="form-group focused">
                  <label class="form-control-label" for="no_hp">No Hp<span class="small text-danger">*</span></label>
                  <input type="text" id="no_hp_edit" class="form-control" name="no_hp" placeholder=">No Hp">
                </div>
                <div class="form-group focused">
                  <label class="form-control-label" for="namakontak">Nama Kontak<span class="small text-danger">*</span></label>
            ...
            <tbody>
              ...
              foreach ($pemasok as $data) : ?>
                <tr>
                  ...
                  <td><?= $data->email ?></td>
                  <td>
                    <form action="<?= base_url('pemasok/hapus/'), $data->id_pemasok ?>" method="POST">
                      <button type="button" class="btn btn-warning btn-sm open_modal" data-toggle="modal" value="<?= $data->id_pemasok ?>" data-target="#EditModal">
                        Edit
                      </button>

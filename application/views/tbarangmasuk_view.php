  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form enctype="multipart/form-data" method="POST" action="<?= base_url('tbarangmasuk/tambah') ?>" autocomplete="off">
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-group focused">
                    <label class="form-control-label" for="jumlah_masuk">Jumlah Masuk<span class="small text-danger">*</span></label>
                    <input type="text" id="jumlah_masuk" class="form-control" name="jumlah_masuk" placeholder="Jumlah Masuk">
                  </div>
                  <div class="form-group focused">
                  ...
                  <div class="form-group focused">
                    <label class="form-control-label" for="id_pemasok">Pemasok<span class="small text-danger">*</span></label>
                    <select type="text" id="id_pemasok" class="form-control" name="id_pemasok">
            ...
            <tbody>
              ...
              foreach ($data as $data) : ?>
                <tr>
                  ...
                  <td><?= $data->nama ?></td>
                  <td>
                    <form action="<?= base_url('tbarangmasuk/hapus/'), $id . "/" . $data->id_trmasuk ?>" method="POST">
